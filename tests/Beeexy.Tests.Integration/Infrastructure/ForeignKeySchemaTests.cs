    ...
    public async Task PersistenceForeignKeys_ExistAndUseRestrictedDeleteBehavior()
    {
        ...
        Assert.Equal(
            [
                ...
                "fk_private_access_credentials_accounts_account_id",
                "fk_private_access_sessions_credentials_credential_id",
                "fk_private_access_sessions_refresh_sessions_root_id",
